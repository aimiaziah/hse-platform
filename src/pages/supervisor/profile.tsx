// src/pages/supervisor/profile.tsx - Supervisor Profile & Settings
...
const SupervisorProfile: React.FC = () => {
  ...
  return (
    <ProtectedRoute requiredRole="supervisor">
      <SupervisorLayout title="Profile & Settings">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              {user?.signatureCreatedAt
                ...
                : 'Draw your signature and set a PIN for approving inspections.'}
            </p>
